...
It is also not mandatory to have a public class in the file.
...
Basically, if you need to create a new class and here is already a class that has some of the code you require,
